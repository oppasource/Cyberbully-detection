    ...
    try:
        if post.find_elements_by_tag_name('ul'):
            ...
            if len(comments) > 1:
                ...
                while ((comments[1].text.lower() == 'load more comments' or comments[1].text.lower().startswith('view all')) and len(comments) <= Settings.limit_amount_comments):
                    try:
            ...
            for comm in comments:
                ...
                if (Settings.output_comments is True or len(user_comments) < 1):
                    ...
                    try:
                        ...
                        if Settings.display_comments is True:
